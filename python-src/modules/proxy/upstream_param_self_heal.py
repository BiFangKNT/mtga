...
@dataclass(frozen=True)
class InvalidRequestErrorSignal:
    message: str | None
    param: str | None
...
def extract_invalid_request_error_signal(
    exc: Exception,
) -> InvalidRequestErrorSignal | None:
    ...
    if message is None and param is None:
        return None
    return InvalidRequestErrorSignal(message=message, param=param)
